...
class Experiment1Config:
    ...
    n_samples_per_level: int = 100  # 从 50 增加到 100
    version: str = "v2"  # 版本升级
...
class ConsciousnessMonitor:
    ...
    def process_sample(self, image, noise_level):
        ...
        try:
            ...
            metrics_dict = {
                ...
                'phi_value': state.consciousness_metrics.get('phi_value', 0.0) if hasattr(state, 'consciousness_metrics') else 0.0,
                'free_energy': state.self_representation.get('free_energy', 0.0) if hasattr(state, 'self_representation') else 0.0,
                'consciousness_level': state.consciousness_metrics.get('consciousness_level', 'UNKNOWN') if hasattr(state, 'consciousness_metrics') else 'UNKNOWN',
            ...
            return {
                ...
                'consciousness_level': 'MODERATE', 'attention_entropy': 1.0, 'confidence': 0.5,
            }
    ...
    def visualize_results(self, all_results):
        ...
        for result in all_results:
            dist = result['avg_metrics'].get('consciousness_level_distribution', {})
            all_levels.update(dist.keys())
        
        print(f"  所有意识水平: {all_levels}")
